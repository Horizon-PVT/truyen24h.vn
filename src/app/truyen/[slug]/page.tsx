...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }) {
  ...
  // Dynamic OG image — 1200×630, fully branded, generated by
  // /api/og/novel/[slug]. Cached 12h server-side.
  const ogImage = absoluteUrl(`/api/og/novel/${slug}`);
  ...
  return {
    ...
    openGraph: {
      ...
      url: canonical,
      siteName: SITE_NAME,
      images: [{ url: ogImage, width: 1200, height: 630, alt: `Bìa truyện ${data.title}` }],
      locale: 'vi_VN',
      type: 'article',
    },
    twitter: {

...
- Runtime, security, payment, Firestore rules, automation, and monetization work must follow `docs/TRUYEN24H_AGENT_OPERATING_CONSTITUTION_AND_MONEY_AUTOMATION.md`.
